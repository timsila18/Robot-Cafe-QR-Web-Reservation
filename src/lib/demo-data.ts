...
export const menuItems: MenuItem[] = [
  ...
  item(10, "Margherita Classico", "Pizza", 1150, "San Marzano tomato, mozzarella, basil, and extra virgin olive oil.", ["imaara-mall", "lana-plaza"]),
  item(11, "Robot Signature Pepperoni", "Pizza", 1380, "Crisp pepperoni, mozzarella, chili honey, and aged parmesan.", ["imaara-mall", "lana-plaza"], { isBestSeller: true }),
  item(12, "Wild Mushroom Bianca", "Pizza", 1490, "White sauce, wild mushrooms, thyme, and truffle finish.", ["lana-plaza"], { isNewArrival: true }),
