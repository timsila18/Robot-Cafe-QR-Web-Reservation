...
export async function AdminMobileNav() {
  ...
  return (
    <nav className="scrollbar-none flex gap-2 overflow-x-auto border-b border-white/10 bg-[#071827]/96 px-4 py-3 text-white shadow-2xl backdrop-blur-xl lg:hidden">
